...
To generate the predictions, it is only necessary to run the script `run.py`. It won't train the model, instead it will just load the weights and produce the submission file. Since we have renamed some images you should use the dataset that you can find in the aforementioned link.
